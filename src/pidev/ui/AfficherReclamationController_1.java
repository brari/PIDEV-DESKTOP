 ...
 * @author brari
 */
public class AfficherReclamationController_1 implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Reclamation  r  = rs.chercherReclamation(ConnexionFXMLController.session.getUser_id());
            ...
            Logger.getLogger(AfficherReclamationController_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
